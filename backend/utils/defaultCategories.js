export const defaultCategories = [
    ...
    { name: 'Investments' , type: 'income' , icon: 'trending-up' , color: '#14BBA6'},
    { name: 'Gifts' , type: 'income' , icon: 'gift' , color: '#06B6D4'},
    { name: 'Other Incomes' , type: 'income' , icon: 'plus-circle' , color: '#0EA5E9'},
    ...
    { name: 'Entertainment' , type: 'expense' , icon: 'film' , color: '#A85CF6'},
    { name: 'Shopping' , type: 'expense' , icon: 'shopping-bag' , color: '#8B5CF6'},
    { name: 'Healthcare' , type: 'expense' , icon: 'heart' , color: '#3BB2F6'},
